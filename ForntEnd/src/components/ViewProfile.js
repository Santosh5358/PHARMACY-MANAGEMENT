...
const ViewProfile = () => {
  ...
  const handleUpdatePhone = async () => {
    try {
      ...
      const response = await axios.put(`https://pharmacy-management-7t8g.onrender.com/update-phone/${userId}`, updatedUser);
  ...
  const handleChangePassword = async () => {
    ...
    try {
      ...
      const response = await axios.post('https://pharmacy-management-7t8g.onrender.com/change-password', {
